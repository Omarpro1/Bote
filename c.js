...
client.login('NTg1Mjc0MjM3MjUwNjk5Mjc2.XP5jlw.8oc10pkJkm9syfgZGT0mN0NqnP0'); 
  ...
  client.on("message", message => {
    if (message.content === "!inv") {
     const embed = new Discord.RichEmbed() 
         .setColor("#00FF00")
         .setThumbnail(message.author.avatarURL)
         .setDescription(`https://discordapp.com/oauth2/authorize?client_id=585274237250699276&scope=bot&permissions=36760572`)
	 message.author.sendEmbed(embed)
...
client.on("message", message => {
    if (message.content === "!support") {
     const embed = new Discord.RichEmbed() 
         .setColor("#00FF00")
         .setThumbnail(message.author.avatarURL)
         .setDescription(`https://discord.gg/sfMzpft`)
...
if(message.content.split(' ')[0] == prefix + 'bc') {
    if (!args[1]) {
message.channel.send("**| Strong | !bc <message> **");
return;
}
